...
print("Accuracy of K-NN classifier on training dataset: {:.2f}".format(knn.score(X_train,Y_train)))
print("Accuracy of K-NN classifier on testing   dataset:{:.2f}".format(knn.score(X_test,Y_test)))
